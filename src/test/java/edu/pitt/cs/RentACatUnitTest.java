...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		...
		assertNull("Expected null when no cat exists at index", ret);
		assertEquals(out.toString().trim(), "Invalid cat ID.");
	}
	 ...
	 * the class object of r instead of hardcoding it as RentACatImpl. 
			 ...
			 * @throws IllegalAccessException 
				 */
				@Test
				public void testGetCatNumCats3() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		// TODO: Fill in
		r.addCat(c1);
		r.addCat(c2);
		r.addCat(c3);
		...
		assertNotNull("The index in r should not return null", ret);
	...
	public void testListCatsNumCats3() {
		...
		assertEquals(cats, "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n");
	}
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse("renameCat should return false if id is not valid.", rename);
	...
	public void testRenameNumCat3() {
		...
		assertTrue("renameCat should return true if id is valid.", rename);
